...
#   function = fed_ensure_auditd_installed
#   applicable =
# # END METADATA
#
#
...
fed_ensure_auditd_installed()
{
	...
	fed_ensure_auditd_installed_chk()
	{
		...
		# Determine if both audit and audit-libs are installed
		if [ -z "$l_output" ]; then
	...
	fed_ensure_auditd_installed_fix()
	{
