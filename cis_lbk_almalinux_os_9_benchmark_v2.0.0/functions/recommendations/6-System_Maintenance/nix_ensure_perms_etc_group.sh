...
#   function = ensure_perms_etc_group
#   applicable =
# # END METADATA
#
#
...
# David Neilson		 11/27/23	  Changed "chmod u-x,g-wx,o-wx /etc/group" to "chmod 644 /etc/group" in the remediation section
# David Neilson		 12/06/23	  Changed "chmod 644 /etc/group" back to "chmod u-x,g-wx,o-wx /etc/group" in the remediation section
